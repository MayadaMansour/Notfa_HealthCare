...
class LanguageFr extends BaseLanguage {
  ...
  String get lblWalkThroughSubTitle1 =>
      "«L'application Notfa est la solution de dossiers de santé électronique (DSE) prêts à l'emploi et ultimes pour les médecins, les professionnels de la santé, la gestion des cliniques et des patients. Quatre modèles uniques pour les médecins, les administrateurs de la clinique, la réceptionniste et les patients.";
  @override
  String get lblWalkThroughSubTitle2 =>
      'Créez votre application mobile ingénieuse en répertoriant les médecins. Vous pouvez trouver un médecin le plus proche de vous avec ce modèle de médecins incroyable. Ajouter et gérer la liste des médecins avec Notfa.';
  @override
  String get lblWalkThroughSubTitle3 =>
      "Gérer les rendez-vous à la clinique ou à l'hôpital, planifiez les patients à l'avance avec l'interface intelligente de Notfa. Évitez les retards ou l'attente plus longue dans les files d'attente";
  @override
  String get lblWalkThroughSubTitle4 =>
      'Les patients peuvent avoir une consultation directe avec le médecin rendant le premier diagnostic précis et opportun. La notification SMS de Notfa envoie des alertes sur le numéro enregistré du patient.';
  @override
  ...
  @override
  String get lblSignUpAsPatient => 'Créez votre compte Notfa';
  @override
  ...
  @override
  String get lblAboutKiviCare => 'À propos de Notfa';
  @override
  ...
  @override
  String get lblShareKiviCare => 'Partager Notfa';
  @override
  String get lblLogout => 'Se déconnecter';
  @override
  ...
  String get lblAboutUsDes =>
      "Notfa est un rendez-vous en clinique / hôpital complet et une gestion des dossiers pour les médecins et les patients. Les informations, les rapports médicaux, les médicaments, les antécédents de visite, les notes cliniques, les antécédents du patient et d'autres notes. Jongler à travers les articles pour voir les antécédents précédents de vos patients, tout est facilement disponible pour votre diagnostic.";
  @override
  ...
  @override
  String get lblEnjoyTheFlawlessKivicareSystemWithEase => 'Apprécier! Le système Notfa impeccable avec facilité.';
  @override
