...
class LanguageDe extends BaseLanguage {
  ...
  String get lblWalkThroughSubTitle1 =>
      '""Die Notfa-App ist die EHR-Lösung für die vorbereitete und ultimative elektronische Gesundheitsakten (ELEPONISIERUNGSBEDEUTUNG) für Ärzte, Mediziner, Klinik und Patientenmanagement. Vier einzigartige Modelle für Arzt, Klinikadministratoren, Empfangsanlagen und Patienten.';

  @override
  String get lblWalkThroughSubTitle2 =>
      'Erstellen Sie Ihre mobile App einfallsreich, indem Sie Ärzte auflisten. Sie können einen Arzt finden, der Ihnen mit diesem erstaunlichen Ärztemodell am nächsten liegt. Fügen Sie die Ärzteliste mit Notfa hinzu und verwalten Sie sie.';

  @override
  String get lblWalkThroughSubTitle3 =>
      'Verwalten Sie Termine in der Klinik oder im Krankenhaus und planen Sie Patienten im Voraus mit intelligenter Notfa -Schnittstelle. Vermeiden Sie Verzögerungen oder längeres Warten in Warteschlangen';

  @override
  String get lblWalkThroughSubTitle4 =>
      'Patienten können direkt mit dem Arzt konsultieren, was die erste Diagnose genau und rechtzeitig darstellt. Die SMS -Benachrichtigung von Notfa sendet Benachrichtigungen über die registrierte Nummer des Patienten.';
  ...
  @override
  String get lblSignUpAsPatient => 'Erstellen Sie Ihr Notfa -Konto';
  ...
  @override
  String get lblAboutKiviCare => 'Über Notfa';
  ...
  @override
  String get lblShareKiviCare => 'Teile Notfa';
  ...
  String get lblAboutUsDes =>
      '""Notfa ist eine vollständige Klinik-/Krankenhaustermin- und Rekordmanagement für Ärzte und Patienten App. Es hilft den Patienten, ihren Arzttermin zu jedem Zeitpunkt leicht zu buchen Informationen, medizinische Berichte, Medikamente, Besuch der Geschichte, klinische Notizen, Patientenanamnese und andere Notizen. Termine für Ihre Patienten können einfach mit der Notfa -App verwaltet werden. Alle Ihre medizinischen Unterlagen für Patienten können Sie sofort betrachten. Also nicht mehr Wenn Sie durch Papiere jonglieren, um die Vorgeschichte Ihrer Patienten zu sehen, ist alles für Ihre Diagnose verfügbar.';
  ...
  @override
  String get lblEnjoyTheFlawlessKivicareSystemWithEase => 'Genießen! Das makellose Notfa -System mit Leichtigkeit.';
