            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (upcomingAppointment.taxData != null && upcomingAppointment.taxData!.taxList.validate().isNotEmpty) Divider(height: 16),
                  if (upcomingAppointment.taxData != null && upcomingAppointment.taxData!.taxList.validate().isNotEmpty)
                    Row(
                      children: [
                  ...
                  if (upcomingAppointment.taxData != null && upcomingAppointment.taxData!.taxList.validate().isNotEmpty) Divider(height: 8),
