...
const primaryColor = Color(0xFFad4573);
...
const scaffoldColorLight = Color(0xFFfffcf3);
...
const ratingBarOrangeColor = Color(0xFFad4573);
const ratingBarLightGreenColor = Color(0xFF73CB92);

const signatureBackgroundColor = Color(0xFFfffcf3);
const datePickerThemeColor = Color(0xFF4974dc);
const progressIndicatorColor = Color(0xFF5CC16C);
const appointmentSlotEveningImageColor = Color(0xFFad4573);
